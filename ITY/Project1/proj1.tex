\documentclass[10pt, a4paper, twocolumn]{article}[28.2. 2024]

\title{Typografie a publikování -- 1. projekt}
\author{Martin Kováčik \\ \href{mailto: xkovacm01@stud.fit.vutbr.cz}{xkovacm01@stud.fit.vutbr.cz}}
\date{}

\usepackage[left=1.8cm, text={18.2cm, 24.1cm},top=1.8cm]{geometry}
...
Zvýraznění barvou, podtržením, ani změnou písma se\break v odstavcích nepoužívá.
...
Pří\-liš časté zvýrazňování textových elementů a změny {\tiny velikosti} písma jsou známkou \textbf{amatérismu} autora a působí \texttt{velmi rušivě}.
...
Balíček \texttt{fontenc} slouží ke korektnímu kódovaní znaků\break s diakritikou, aby bylo možno v textu vyhledávat a kopírovat z něj.
